    ...
    ContextMenu.prototype.render = function () {
        ...
        if (this.state.activated) {
            return (React.createElement("div", { style: styles.card(this.props.color, this.props.compact), title: this.props.title },
                ...
                React.createElement(button_1.default, { style: styles.button(this.props.compact, "", true), image: "/data/images/x.png", onClick: function (e) { return _this.toggle(); }, title: "Close" }),
            ...
            return (React.createElement(button_1.default, { image: "/data/images/configure.png", title: "File Options", onClick: function (e) { return _this.toggle(); }, style: styles.button(this.props.compact, "", false, this.props.isHovering) }));
        }
    };
