    ...
    LocationBar.prototype.render = function () {
        ...
        return (React.createElement("div", { style: __assign({}, styles.bar(), styles.mobile(), this.props.style) },
            ...
            this.props.showFileOptions ? (React.createElement("div", { style: styles.fileOptions(util_1.isMobile()) },
                React.createElement(text_editor_1.default, { username: this.props.username, path: this.props.path }),
                React.createElement(new_folder_1.default, { username: this.props.username, path: this.props.path }),
                React.createElement(move_file_1.default, { username: this.props.username, path: this.props.path }),
                React.createElement(sharing_settings_1.default, { username: this.props.username, path: this.props.path }),
                !util_1.isMobile() ?
