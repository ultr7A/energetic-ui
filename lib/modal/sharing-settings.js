                                ...
                                this.props.shares.map(function (s, i) {
                                    return (React.createElement("tr", { key: i },
                                        ...
                                        React.createElement("td", null,
                                            " ",
                                            React.createElement(file_button_1.default, { title: "Remove", onClick: function () { _this.remove(i); } }))));
                                })))),
                    React.createElement("div", { style: styles.body },
                        React.createElement(file_button_1.default, { title: "Share Current Folder", onClick: function () { _this.shareFolder(); } }),
                        React.createElement(file_button_1.default, { title: "Close", onClick: function () { _this.toggleModal(); }, style: styles.cancelButton })))));
        }
        else {
