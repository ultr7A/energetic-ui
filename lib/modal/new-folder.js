            ...
            return (React.createElement("div", { style: styles.lightbox },
                React.createElement("div", { style: styles.modal },
                    ...
                    React.createElement("div", { style: styles.body },
                        ...
                        React.createElement(file_button_1.FileButton, { title: "Make", onClick: function () { _this.make(); } }),
                        React.createElement(file_button_1.FileButton, { title: "Cancel", onClick: function () { _this.toggleModal(); }, style: styles.cancelButton })))));
        }
        else {
            return (React.createElement(file_button_1.FileButton, { title: "New Folder", onClick: function () { _this.toggleModal(); } }));
        }
    };
    return NewFolder;
}(react_1.Component));
